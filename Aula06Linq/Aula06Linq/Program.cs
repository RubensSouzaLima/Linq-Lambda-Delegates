using Aula06Linq.Entities;

namespace Aula06Linq
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Category Avarage prices: " + r12);

            var r13 = products.Where(p => p.Category.Id == 5).Select(p => p.Price).DefaultIfEmpty(0.0).Average();
            Console.WriteLine("Category 5 prices " + r13);
            ...
            Console.WriteLine("Category 5 (does not exist) aggregate sum: " + r15);
            ...
            {
                Console.WriteLine("Category Group by " + group.Key.Name + ": ");
